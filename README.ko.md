<p align="center">
  <img src="./assets/banner.svg" alt="XXD Panel 005 프로젝트 배너" width="1200">
</p>
...
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#네-가지-출력-하나의-판화-논리)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089987808664719723"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 005 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089987808664719723"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 005 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089987808664719723"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 005 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089987808664719723"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 005 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 005 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 005 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 005 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 005 예시 8"></td>
  </tr>
</table>

## 추가 3:4 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 005의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 005 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 005 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 005 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 005 추가 상하 예시 4"></td>
  </tr>
</table>

> 추가 예시: 천샹 포스터 그룹에서 해당 천샹 포스터 그룹의 네 장을 파일명 순서로 사용하고, 이 Panel의 원본 브리프에 따라 16:9 좌우 구성과 영어 자동 생성 문구로 제작했습니다.

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2089987808664719723) · 2026-08-19<br>
> GPT2 x 格林童话 x 转绘 x 童趣 x 美学提示词 x VOL.005

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2089987808664719723">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 005의 미학적 의도를 보여 줄 뿐이며, 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 생성 참고나 현재 기본값이 되지 않습니다.

> 둔중한 큰 형태 · 어두운 구조장 · 부분 드러냄 · 3층 색 질서 · 실크스크린 × 파스텔

XXD Panel 005는 Codex와 호환 에이전트를 위한 이미지 생성 Skill입니다. 사진 속 실제 정체성, 동작, 기능과 감정을 보존하고 주제를 한두 개의 둔중하지만 알아볼 수 있는 큰 형태로 압축합니다. 원본의 공간과 의미에서 어두운 구조장을 자라게 하고, 가림·크롭·삼킴·부분 드러냄으로 동화 판화의 서사를 만듭니다.

색은 어두운 구조, 밝은 여백, 아주 작은 고채도 신호의 세 층을 지킵니다. 평면 실크스크린과 가루 같은 파스텔이 드라이 브러시, 입자, 종이결, 분사점, 끊긴 흰색과 미세한 판 어긋남을 남깁니다. 글자는 작은 표지, 사물 패널 또는 가장자리 주석으로만 구조 안에 들어갑니다.
...
**Panel 005**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진을 어두운 구조와 작은 선명색이 이야기를 만드는 동화 판화로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 005으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 005이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진을 어두운 구조와 작은 선명색이 이야기를 만드는 동화 판화로 |
| **한눈에 알아볼 특징** | 둔중한 큰 형태 · 어두운 구조장 · 부분 드러냄 · 3층 색 질서 · 실크스크린 × 파스텔 |
...
일반적인 ‘동화풍’은 어두운 배경에 밝은 색을 고르게 뿌리고 성, 별, 웃는 얼굴을 붙이는 흔한 귀여운 만화로 쉽게 무너집니다.

005은 순서를 뒤집습니다.

```text
원본 사실 고정 → 한두 개의 둔중한 형태로 압축 → 원본에서 어두운 구조장 성장 → 가림과 부분 드러냄으로 서사 구성 → 어두움／밝음／선명색의 세 층 고정 → 실크스크린과 가루 파스텔로 마감
```

무관한 사진으로 바꿔도 큰 형태, 어두운 장의 역할, 가림 논리, 선명색 신호와 문구가 거의 그대로 성립한다면 005가 아닙니다.

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- **한두 개의 둔중한 큰 형태:** 최소 세 가지 원본 고유 단서로 정체성, 동작, 기능과 감정을 보존합니다.
- **원본에서 자라는 어두운 장:** 큰 저명도 구조가 용기, 길, 프레임 또는 밀도 껍질로 분명히 작동합니다.
- **구조적 서사:** 가림, 크롭, 삼킴과 부분 드러냄이 정보의 순서를 만듭니다.
- **평면 그림책 시점:** 압축된 부감, 측면 이동, 정면 프레임, 길 유도, 크기 도약, 가장자리 크롭 중 하나를 선택합니다.
- **3층 색 질서:** 어두운 구조는 무게, 밝은 장은 호흡, 작은 고채도 색은 읽기와 이야기 신호를 맡습니다.
- **성긴 기능선:** 선은 기능, 경로, 경계, 질감과 식별에만 나타납니다.
- **실크스크린 × 파스텔:** 평면 색에 드라이 브러시, 입자, 종이결, 분사점, 끊긴 흰색과 미세한 판 어긋남을 남깁니다.
- **구조 안의 글자:** 둥글고 둔중한 저밀도 작은 표지, 사물 패널 또는 가장자리 주석으로 처리합니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 005의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-005 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-005 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-005 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-005 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-005 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-005 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 005 적용, 공통 설정은 한 번만 확정
/xxd-panel-005 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
...
Claude Code 사용자는 같은 폴더를 `~/.claude/skills/xxd-panel-005`에 연결할 수 있습니다. 설치 후 에이전트 세션을 다시 시작하세요.
...
- [Skill 워크플로](SKILL.md)
- [중문 런타임 어댑터](references/xxd-panel-005-prompt.zh-CN.md)
- [영문 런타임 어댑터](references/xxd-panel-005-prompt.en.md)
...
**어두운 장은 잡음을 숨기고, 진짜 중요한 한 점만 이야기를 밝히게 합니다.**
