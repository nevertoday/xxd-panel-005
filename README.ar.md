...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 005 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 005 على التكيف فقط، ولن تصبح موضوعاتها أو استعاراتها أو ألوانها أو نصوصها أو نسبها مراجع للتوليد أو قيماً افتراضية.
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى، وحكاية 005 البنيوية المطبوعة في الأسفل؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار، وحكاية 005 البنيوية المطبوعة في اليمين؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `005.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
- **أربعة أعمال مستقلة:** يرجع كل جهاز إلى الصورة الأصلية وحدها، ويستكشف كتلاً غليظة ووظيفة مختلفة للحقل الداكن وبنية حجب وإشارة لونية وموضع نص.
...
ينشئ نموذج الصور الكتل الغليظة والحقل البنيوي الداكن النامي من المصدر وسرد الحجب والترتيب اللوني الثلاثي وخامة الطباعة الحريرية مع الباستيل والنص داخل البنية. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة؛ ولا يرسم العمل برمجياً.
